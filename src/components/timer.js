    ...
    <>
      <div className="bg-white pb-24 sm:pb-32 px-6 sm:px-12 fixed top-0 w-full border-bottom shadow-xl left-0 right-0">
        <div className="flex apart">
          ...
          <a href="https://github.com/thall1961/standup" className="text-xl font-bold">github</a>
        </div>
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto">
            <div className="mb-6">
              <h2 className="text-9xl font-black mt-12 text-center">{secondsLeft}</h2>
              <p className="text-center">seconds left</p>
            </div>
          </div>
          <button className="bg-indigo-500 block mx-auto w-200 text-white text-xl mt-5 py-8 px-12 rounded shadow hover:bg-indigo-900 hover:shadow-xl transition" onClick={() => setGoing(!going)}>Start/Stop</button>
        </div>
      </div>
      <img
        src={Reaper}
